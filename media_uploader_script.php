...
<div style="" class="image_container<?php echo $name; ?>">
	<div class="align-items-center row">
	<div class="col-8">
	<div style="input-group form-row">
    <?php
			echo "<input style=\"float: left; width:85%;\" type=\"text\" placeholder=\"Choose a png transparent image\" class=\"form-control textbox_custom\" name=\"$name\" id=\"$name\"   value=\"$choosed_option_value\" size=\"25\">";
			?>
	...
	if($choosed_option_value == '') $choosed_option_value = $pluginsurl . '/images/no-logo-avaliable.gif?x=ctp_main_watermark_pass';
	?>
	<div class="col-4" style="padding-bottom: 5px;">
		<div class="image_holder center-block" id="image_holder_<?php echo $name; ?>">
			<img id="slide_image_<?php echo $name; ?>" src="<?php echo $choosed_option_value; ?>?x=ctp_main_watermark_pass">
		</div>
	</div>
	</div>
</div>